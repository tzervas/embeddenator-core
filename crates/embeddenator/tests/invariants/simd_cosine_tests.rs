...
fn test_cosine_scalar_basic() {
    ...
    let a = SparseVec::encode_data(b"hello world", &cfg, None);
    let b = SparseVec::encode_data(b"hello world", &cfg, None);
...
fn test_cosine_properties() {
    let cfg = ReversibleVSAConfig::default();
    let a = SparseVec::encode_data(b"alpha", &cfg, None);
    let b = SparseVec::encode_data(b"beta", &cfg, None);
...
fn test_simd_matches_scalar_basic() {
    ...
    for (data_a, data_b) in test_cases {
        let a = SparseVec::encode_data(data_a, &cfg, None);
        let b = SparseVec::encode_data(data_b, &cfg, None);
...
fn test_cosine_with_feature_gate() {
    ...
    let cfg = ReversibleVSAConfig::default();
    let a = SparseVec::encode_data(b"test vector a", &cfg, None);
    let b = SparseVec::encode_data(b"test vector b", &cfg, None);
